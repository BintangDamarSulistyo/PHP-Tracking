                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="col-md-10">
                                    <form class="form-inline right" method="GET" action="/berkasanggaran">
									...
									<table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$tracking->kelengkapan}}</td>
                                            <td>{{$tracking->keterangan}}</td>
                                            <td><a href="/berkasanggaran/{{$tracking->no_dokumen}}/editanggaran" class="btn btn-warning">Masukan</a></td>
                                        </tr>
                                        @endforeach
										</tbody>
									</table>
