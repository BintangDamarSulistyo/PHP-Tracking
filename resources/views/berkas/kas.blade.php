                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="col-md-10">
                                    <form class="form-inline right" method="GET" action="/berkaskas">
									...
									<table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$tracking->persetujuan_asman}}</td>
                                            <td>{{$tracking->keterangan}}</td>
                                            <td><a href="/berkaskas/{{$tracking->no_dokumen}}/editkas" class="btn btn-warning">Masukan</a></td>
                                        </tr>
                                        @endforeach
										</tbody>
									</table>
