...
<head>
	<title>Aplikasi Tracking Pasar Jaya</title>
	<meta charset="utf-8">
			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{asset('admin/logo-login.jpg')}}" alt="LOGIN"></div>
									</div>
										...
										<br>
										<a href="/statususer" class="">Mau cek berkas? Klik disini..</a>
										</form>
										</div>
									</div>
								<div class="right">
